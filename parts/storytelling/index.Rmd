...
# Download [this cheatsheet](https://jhelvy.github.io/stories-with-data/content/cheatsheet-storytelling.pdf) for today's content
...
### 2. With a shocking factoid ("40k people die in car accidents every year...").
...
Brainstorm different strategies for how to start a presentation you are working on:

1. Tell a story, talk about **people** ("Imagine...").
2. With a **factoid** ("40k people die in car accidents every year...").
3. With a **question** that matters to the audience ("Have you ever...?").
